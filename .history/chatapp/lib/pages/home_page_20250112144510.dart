  ...
  Widget _builderUserList() {
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        var filteredUsers = users.where((user) => user['email'] != currentUserEmail).toList();
        return ListView(
          children: filteredUsers.map<Widget>((userData) => _builderUserListItem(userData, context)).toList(),
        );
      },
    );
  }
