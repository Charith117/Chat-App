import 'package:chatapp/components/botton_nav.dart' as components;
import 'package:chatapp/components/my_drawer.dart';
import 'package:chatapp/components/user_tile.dart';
import 'package:chatapp/pages/chat_page.dart' as pages;
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(), // Add your BottomNavBar here
    );
  }
  ...
  Widget _builderUserListItem(
    ...
    if(userData["email"] != _authService.getCurrentUser()!.email){
      ...
      Navigator.push(context,MaterialPageRoute(builder:(context)=>pages.ChatPage(
