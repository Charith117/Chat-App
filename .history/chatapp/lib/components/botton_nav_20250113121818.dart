        ...
        items: [
          BottomNavigationBarItem(
            icon: Container(
              ...
              width: 60,
              height: 50, // Changed width to be a bit longer
              decoration: BoxDecoration(
                color: _currentIndex == 0 ? Colors.grey.withOpacity(0.5) : Colors.transparent,
          ...
          BottomNavigationBarItem(
            icon: Container(
              padding: EdgeInsets.all(8), // Added padding
              width: 60,
              height: 40, // Changed width to be a bit longer
              decoration: BoxDecoration(
                color: _currentIndex == 1 ? Colors.grey.withOpacity(0.5) : Colors.transparent,
                borderRadius: BorderRadius.circular(30),
              ),
          ...
          BottomNavigationBarItem(
            icon: Container(
              ...
              height: 40, // Changed width to be a bit longer
              decoration: BoxDecoration(
                color: _currentIndex == 2 ? Colors.grey.withOpacity(0.5) : Colors.transparent,
                borderRadius: BorderRadius.circular(30),
              ),
          ...
          BottomNavigationBarItem(
            icon: Container(
              ...
              height: 40, // Changed width to be a bit longer
              decoration: BoxDecoration(
                color: _currentIndex == 3 ? Colors.grey.withOpacity(0.5) : Colors.transparent,
                borderRadius: BorderRadius.circular(30),
              ),
