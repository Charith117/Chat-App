      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            icon: Container(
              decoration: BoxDecoration(
                color: _currentIndex == 0 ? Colors.purpleAccent : Colors.transparent,
          ...
          BottomNavigationBarItem(
            icon: Container(
              decoration: BoxDecoration(
                color: _currentIndex == 1 ? Colors.purpleAccent : Colors.transparent,
                borderRadius: BorderRadius.circular(8),
              ),
          ...
          BottomNavigationBarItem(
            icon: Container(
              decoration: BoxDecoration(
                color: _currentIndex == 2 ? Colors.purpleAccent : Colors.transparent,
                borderRadius: BorderRadius.circular(8),
              ),
          ...
          BottomNavigationBarItem(
            icon: Container(
              decoration: BoxDecoration(
                color: _currentIndex == 3 ? Colors.purpleAccent : Colors.transparent,
                borderRadius: BorderRadius.circular(8),
              ),
