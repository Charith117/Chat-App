...
class UpdatesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Center(
        child: Text('Updates Page', style: TextStyle(color: Colors.orange[900], fontSize: 24)),
      ),
    );
  }
}
...
class AddMorePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Center(
        child: Text('Add More Page', style: TextStyle(color: Colors.purple[900], fontSize: 24)),
      ),
    );
  }
